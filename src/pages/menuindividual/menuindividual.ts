...
//        }
//        else {
//            if (this.listMenuIndividual.length > 0) {
...
export class MenuIndividual extends PagerPage {
    
    constructor(private miService: MenuIndividualService, protected utilService: UtilService, private credService: CredService) {
        super(utilService, 3);
        this.refreshData(); 
    }
    ...
    public refreshData() {
        this.arrOriginObjects = this.utilService.cloneObject(this.miService.miList);
