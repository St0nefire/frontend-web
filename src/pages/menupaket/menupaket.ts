...
//        this.refreshData(); 
    ...
    public refreshData() {
//        setTimeout(() => {
//            let obs = this.spService.getScheduledPackages();
//                obs.subscribe(
//                    data => {
//                        this.loading = false;
...
//                            this.arrOriginMenuPaket = data.scheduledPackageList;
...
//        this.utilService.printObject("SP LIST: ", this.spService.spList)
    ...
    private makeMenuPages(menuArray: any[]) {
        ...
        if (menuArray) {
            ...
            this.arrAllMenuPaket = null;
            this.listMenuPaket = null;
        }
    }
